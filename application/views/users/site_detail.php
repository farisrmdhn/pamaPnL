...
<p>id : <?php echo $info['id'];?> | username : <?php echo $info['username'];?></p>
...
<?php if($this->session->userdata('user_type') == 2):?>
  <a class="btn btn-dark" href="<?php echo base_url();?>permitsAndLicenses/select_pl/<?php echo $info['id']?>">Edit Permit/License Detail</a>
<?php endif;?>
<?php if($this->session->userdata('user_type') == 2):?>
  <a class="btn btn-warning" href="<?php echo base_url();?>permitsAndLicenses/edit_na/<?php echo $info['id']?>">Select Available Matrix</a>
<?php endif;?>
<?php if($this->session->userdata('user_type') == 2):?>
  <a class="btn btn-secondary" href="<?php echo base_url();?>users/export_per_site/<?php echo $info['id']?>">Download site report</a>
<?php endif;?>
	...
	<div class="row">
      ...
      <div class="text-center">
          ...
          <div class="col-md-2" style="display: inline-block;">
            ...
            <a href="<?php echo base_url(); ?>permitsAndLicenses/pl_site_details_by_status/<?php echo $info['id'];?>/2" style="color: black;"> Proses Perpanjangan </a>
          </div>
          <div class="col-md-2" style="display: inline-block;">
